...
public class SelectorAttrs {
    ...
    public static void obtainsAttrs(Context context, View view, AttributeSet attrs) {
        ...
        if (a.hasValue(R.styleable.MzzView_sel_background_pressed) || a.hasValue(R.styleable.
                MzzView_sel_background_border_pressed)) {
            bitmapDrawablePressed = a.getDrawable(R.styleable.MzzView_sel_background_pressed);
        ...
        if (a.hasValue(R.styleable.MzzView_sel_background_selected) || a.hasValue(R.styleable.MzzView_sel_background_border_selected)) {
            bitmapDrawableSelected = a.getDrawable(R.styleable.MzzView_sel_background_selected);
        ...
        if (bitmapDrawable == null) {
            ...
            if (bg == null && a.hasValue(R.styleable.MzzView_sel_background)) { // 兼容旧版本属性
                bg = a.getDrawable(R.styleable.MzzView_sel_background);
            }
        ...
        // 形狀
        int shape = a.getInt(R.styleable.MzzView_sel_background_shape, RECTANGLE);
        if (shape == LINE) {
        ...
        // 圆角
        int backgroundCorners = a.getDimensionPixelOffset(R.styleable.MzzView_sel_background_corners, 0);
        ...
        final int topLeftRadius = a.getDimensionPixelSize(
                R.styleable.MzzView_sel_background_corner_topLeft, radius);
        final int topRightRadius = a.getDimensionPixelSize(
                R.styleable.MzzView_sel_background_corner_topRight, radius);
        final int bottomLeftRadius = a.getDimensionPixelSize(
                R.styleable.MzzView_sel_background_corner_bottomLeft, radius);
        final int bottomRightRadius = a.getDimensionPixelSize(
                R.styleable.MzzView_sel_background_corner_bottomRight, radius);
        ...
        // border
        int backgroundBorderWidth = a.getDimensionPixelOffset(R.styleable.MzzView_sel_background_border_width, -1);
        ...
        if (a.hasValue(R.styleable.MzzView_sel_background_border_color)) {
            int backgroundBorder = a.getColor(R.styleable.MzzView_sel_background_border_color, -1);
            if (colorShapeDrawable != null) {
        ...
        // 如果没有设置背景图片，则读取背景颜色
        if (colorShapeDrawablePressed != null && a.hasValue(R.styleable.MzzView_sel_background_pressed)) {
            int backgroundPressed = a.getColor(R.styleable.MzzView_sel_background_pressed, 0);
            colorShapeDrawablePressed.setColor(backgroundPressed);
        }
        if (colorShapeDrawablePressed != null && a.hasValue(R.styleable.MzzView_sel_background_border_pressed)) {
            int backgroundBorderPressed = a.getColor(R.styleable.MzzView_sel_background_border_pressed, -1);
            colorShapeDrawablePressed.setStroke(backgroundBorderWidth, backgroundBorderPressed);
        }
        if (colorShapeDrawableSelected != null && a.hasValue(R.styleable.MzzView_sel_background_selected)) {
            int backgroundSelected = a.getColor(R.styleable.MzzView_sel_background_selected, -1);
            colorShapeDrawableSelected.setColor(backgroundSelected);
        }
        if (colorShapeDrawableSelected != null && a.hasValue(R.styleable.MzzView_sel_background_border_selected)) {
            int backgroundBorderSelected = a.getColor(R.styleable.MzzView_sel_background_border_selected, -1);
        ...
        if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.LOLLIPOP // 低于21（5.0）版本
                && a.hasValue(R.styleable.MzzView_sel_background_ripple)) { // 但设置了ripple，处理兼容则把ripple的颜色设为按下时的颜色

            Drawable drawable = null;
            if (a.hasValue(R.styleable.MzzView_sel_background_ripple_mask)) { // 根据mask设置形状
                drawable = a.getDrawable(R.styleable.MzzView_sel_background_ripple_mask);
                if (drawable instanceof ColorDrawable) { // mask为颜色类型才可以设置形状
                    ...
                    ((GradientDrawable) drawable).setColor(a.getColor(R.styleable.MzzView_sel_background_ripple, 0));
                } else {
                    drawable = a.getDrawable(R.styleable.MzzView_sel_background_ripple);
                }
            } else {
                drawable = a.getDrawable(R.styleable.MzzView_sel_background_ripple);
            }
    ...
    private static void parseRippleMaskShape(GradientDrawable maskShapeDrawable, TypedArray a) {
        // 必须设置颜色
        maskShapeDrawable.setColor(a.getColor(R.styleable.MzzView_sel_background_ripple_mask, Color.TRANSPARENT));

        // Mask形状
        int shape = a.getInt(R.styleable.MzzView_sel_background_ripple_mask_shape, RECTANGLE);
        if (shape == LINE) {
        ...
        // mask圆角
        int backgroundCorners = a.getDimensionPixelOffset(R.styleable.MzzView_sel_background_ripple_mask_corners, 0);
        final int radius = backgroundCorners;
        maskShapeDrawable.setCornerRadius(backgroundCorners);

        final int topLeftRadius = a.getDimensionPixelSize(
                R.styleable.MzzView_sel_background_ripple_mask_corner_topLeft, radius);
        final int topRightRadius = a.getDimensionPixelSize(
                R.styleable.MzzView_sel_background_ripple_mask_corner_topRight, radius);
        final int bottomLeftRadius = a.getDimensionPixelSize(
                R.styleable.MzzView_sel_background_ripple_mask_corner_bottomLeft, radius);
        final int bottomRightRadius = a.getDimensionPixelSize(
                R.styleable.MzzView_sel_background_ripple_mask_corner_bottomRight, radius);
        if (topLeftRadius != radius || topRightRadius != radius ||
                bottomLeftRadius != radius || bottomRightRadius != radius) {
    ...
    private static boolean parseRipple(View view, TypedArray a, Drawable content) {
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.LOLLIPOP) {
            if (a.hasValue(R.styleable.MzzView_sel_background_ripple)) {
                hasRipple = true;
                ...
                if (a.hasValue(R.styleable.MzzView_sel_background_ripple_mask)) {
                    maskBitmapDrawable = a.getDrawable(R.styleable.MzzView_sel_background_ripple_mask);
                ...
                RippleDrawable rippleDrawable = new RippleDrawable(
                        a.getColorStateList(R.styleable.MzzView_sel_background_ripple),
